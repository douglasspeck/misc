    ...
    <body>
        ...
        <main>
            ...
            <section>
                ...
                <section>
                    <h3>Formação de Profissionais na Área da Surdez</h3>
                    <p>Há inúmeros profissionais empenhados no ensino de surdos e na facilitação da comunicação entre surdos e ouvintes de maneira geral.</p>
                    <p>Dentro do contexto escolar, há três principais papéis sendo desempenhados na área:</p>
                    <ul>
                        <li><strong>Professor Surdo</strong>
                            <ul>
                                <li>Podem trabalhar em Escolas Bilíngues no modelo INES, voltadas apenas para surdos.</li>
                                <li>Podem trabalhar também em Escolas Bilíngues no modelo Escola Polo, onde há também alunos ouvintes, porém há uma preocupação maior com a educação bilíngue.</li>
                                <li>Atua em especial como uma <strong>Referência linguística cultural identitária</strong>
                                    <ul>
                                        <li>Aula <strong>de</strong> Libras</li>
                                        <li>Aula <strong>em</strong> Libras</li>
                        ...
                        <li><strong>Professor ouvinte</strong>
                            <ul>
                                <li>É Bilíngue?
                                    <ul>
                                        <li>Referência linguística ouvinte</li>
                                        <li>Aula em Libras</li>
                                        <li>Regência</li>
                                    </ul>
                                </li>
                                <li>Não é Bilíngue?
                        ...
                        <li><strong>Tradutor/Intérprete</strong>
                            <ul>
                                <li>Tradução
                                    <ul>
                                        <li>Tradução não-simultânea</li>
                                        <li>Materiais, Provas, Vídeos, etc.</li>
                                        <li>Os intérpretes <strong>podem</strong> trabalhar como tradutores</li>
                                    </ul>
                                </li>
                                <li>Interpretação
                                    <ul>
                                        <li>Tradução Simultânea</li>
                                        <li>Processo linguístico, temático, terminológico e performático</li>
                                        <li>TILSP: Libras <–> LP</li>
                                        <li>Intérprete Surdo: Tradução entre línguas de sinais, como ASL ou Gestuno</li>
                                        <li>Lei 12.319/10</li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li><strong>Professor do Atendimento Educacional Especializado</strong>
                            <ul>
                                <li>Chamada informalmente de "Sala de Reforço" ou "Sala de Recursos"</li>
                            </ul>
                        </li>
                    </ul>
                    <section>
                        <h4>Como facilitar a vida do intérprete?</h4>
                        <ul>
                            <li>Olhar para o intérprete, compreender o ritmo/tempo do mesmo
                                <ul>
                                    <li>Atentar-se para os casos em que a datilologia é necessária, porque a mesma demanda mais tempo, assim como sinais compostos</li>
                                </ul>
                            </li>
                            <li>Falar pausadamente e com clareza</li>
                            <li>Fazer pausas estratégicas durante a aula, intercalando discussões com exercícios, por exemplo</li>
                            <li>Discutir o tema e termos específicos da aula previamente com o intérprete</li>
                            <li>O foco do direcionamento do olhar deve ser o(s) aluno(s) surdo(s), exceto, é claro, nas breves comunicações com o intérprete.</li>
                        </ul>
                    </section>
                </section>
            </section>
